...
class CrisisReportDownloadsContainer extends React.Component<Props, State> {
...
// $FlowFixMe
export default connect(mapStateToProps, mapDispatchToProps)(CrisisReportDownloadsContainer);
