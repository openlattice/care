...
class HealthReportSummaryContainer extends React.Component {
  ...
  render() {
    ...
    const consumerInfo = {
      ...
      selfDiagnosisOther: selectedReport.getIn([CONSUMER_INFO.SELF_DIAGNOSIS_OTHER_FQN, 0], ''),
      ...
      observedBehaviorsOther: selectedReport.getIn([CONSUMER_INFO.OBSERVED_BEHAVIORS_OTHER_FQN, 0], ''),
