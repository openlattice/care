    ...
    <div>
      ...
      <PaddedRow>
        <Col lg={6}>
          ...
          <FormControl data-section={section} name='lastName' value={input.lastName} onChange={handleTextInput} disabled={consumerIsSelected || isInReview()} />
        </Col>
        <Col lg={6}>
          <TitleLabel>First Name</TitleLabel>
          <FormControl data-section={section} name='firstName' value={input.firstName} onChange={handleTextInput} disabled={consumerIsSelected || isInReview()} />
        </Col>
      </PaddedRow>
      ...
      <PaddedRow>
        <Col lg={6}>
          ...
          <FormControl data-section={section} name='middleName' value={input.middleName} onChange={handleTextInput} disabled={consumerIsSelected || isInReview()} />
        </Col>
        <Col lg={6}>
          <TitleLabel>13. Consumer Identification</TitleLabel>
          <FormControl data-section={section} name='identification' value={input.identification} onChange={handleTextInput} disabled={consumerIsSelected || isInReview()} />
        </Col>
      </PaddedRow>
      ...
      <PaddedRow>
        <Col lg={12}>
          ...
          <FormControl data-section={section} name='street' value={input.street} onChange={handleTextInput} disabled={isInReview()} />
        </Col>
      </PaddedRow>
      ...
      <PaddedRow>
        <Col lg={6}>
          ...
          <FormControl data-section={section} name='city' value={input.city} onChange={handleTextInput} disabled={isInReview()} />
        </Col>
        <Col lg={6}>
      ...
      <PaddedRow>
        <Col lg={6}>
          ...
          <FormControl data-section={section} name='county' value={input.county} onChange={handleTextInput} disabled={isInReview()} />
        </Col>
        <Col lg={6}>
          <TitleLabel>Zip</TitleLabel>
          <FormControl data-section={section} name='zip' value={input.zip} onChange={handleTextInput} disabled={isInReview()} />
        </Col>
      </PaddedRow>
      ...
      <PaddedRow>
        <Col lg={6}>
          ...
          <FormControl data-section={section} name='phone' value={input.phone} onChange={handleTextInput} disabled={isInReview()} />
        </Col>
      </PaddedRow>
      ...
      <PaddedRow>
        <Col lg={12}>
          ...
          <FormControl data-section={section} name='homelessLocation' value={input.homelessLocation} onChange={handleTextInput} disabled={isInReview()} />
        </Col>
      </PaddedRow>
      ...
      <PaddedRow>
        <Col lg={12}>
          ...
          <FormControl data-section={section} name='drugType' value={input.drugType} onChange={handleTextInput} disabled={isInReview()} />
        </Col>
      </PaddedRow>
        ...
        <Col lg={12}>
          <TitleLabel>19. Self Diagnosis</TitleLabel>
            ...
            <OtherWrapper>
              ...
              <FormControl data-section={section} name='selfDiagnosisOther' value={input['selfDiagnosisOther']} onChange={handleTextInput} disabled={isInReview()} />
            </OtherWrapper>
          </FormGroup>
        </Col>
      </PaddedRow>
          ...
          <FormGroup>
            ...
            <OtherWrapper>
              <InlineCheckbox
                  ...
                  onChange={handleCheckboxChange}
                  disabled={isInReview()}>Other:</InlineCheckbox>
              <FormControl data-section={section} name='observedBehaviorsOther' value={input.observedBehaviorsOther} onChange={handleTextInput} disabled={isInReview()} />
            </OtherWrapper>
          </FormGroup>
        </Col>
      </PaddedRow>
          ...
          <FormGroup>
            ...
            <OtherWrapper>
              <InlineCheckbox
                  ...
                  onChange={handleCheckboxChange}
                  disabled={isInReview()}>Other:</InlineCheckbox>
              <FormControl data-section={section} name='emotionalStateOther' value={input.emotionalStateOther} onChange={handleTextInput} disabled={isInReview()} />
            </OtherWrapper>
          </FormGroup>
        </Col>
      </PaddedRow>
          ...
          <FormGroup>
            ...
            <OtherWrapper>
              <InlineCheckbox
                  ...
                  onChange={handleCheckboxChange}
                  disabled={isInReview()}>Other:</InlineCheckbox>
              <FormControl data-section={section} name='suicideAttemptMethodOther' value={input.suicideAttemptMethodOther} onChange={handleTextInput} disabled={isInReview()} />
            </OtherWrapper>
          </FormGroup>
        </Col>
      </PaddedRow>
