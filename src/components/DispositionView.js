...
import { PaddedRow, TitleLabel, OtherWrapper, InlineCheckbox, InlineRadio, SectionHeader, ErrorMessage } from '../shared/Layout';
      ...
      { !isInReview() ? <SectionHeader>Disposition</SectionHeader> : null}
        ...
        <PaddedRow>
          <Col lg={6}>
            ...
            <FormControl data-section={section} name='hospital' value={input.hospital} onChange={(e) => handleTextInput(e, this, 'string', REQUIRED_FIELDS)} disabled={isInReview()} />
          </Col>
        </PaddedRow>
          ...
          <Col lg={12}>
            ...
            <FormGroup>
              ...
              <OtherWrapper>
                ...
                <FormControl data-section={section} name='deescalationTechniquesOther' value={input.deescalationTechniquesOther} onChange={(e) => handleTextInput(e, this, 'string', REQUIRED_FIELDS)} disabled={isInReview()} />
              </OtherWrapper>
            </FormGroup>
          </Col>
        </PaddedRow>
        ...
        <PaddedRow>
          <Col lg={12}>
            <FormGroup validationState={bootstrapValidation(this, 'incidentNarrative', true)}>
              ...
              <FormControl data-section={section} name='incidentNarrative' componentClass='textarea' value={input.incidentNarrative} onChange={(e) => handleTextInput(e, this, 'string', REQUIRED_FIELDS)} disabled={isInReview()} />
            </FormGroup>
          </Col>
        </PaddedRow>

        { !isInReview() ? <FormNav prevPath={FORM_PATHS.COMPLAINANT} nextPath={FORM_PATHS.OFFICER} handlePageChange={this.handlePageChange} setDidClickNav={this.setDidClickNav} /> : null}
        { this.renderErrors() }
      </div>
    );
  }
