...
const EncampmentsContainer = () => {
  ...
  const optionsFetchState = useSelector((store) => store.getIn([...ENCAMPMENT_STORE_PATH, 'options', 'fetchState']));
  const options = useSelector((store) => store.getIn([...ENCAMPMENT_STORE_PATH, 'options', 'data']));
